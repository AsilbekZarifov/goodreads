...
class BookReviewAPITestCase(APITestCase):
    def setUp(self):
        self.user = CustomUser.objects.create(username="asilbek", first_name="Asilbek")
        self.user.set_password("somepass")
        self.user.save()
        self.client.login(username='asilbek', password='somepass')
    ...
    def test_book_review_detail(self):
        ...
        self.assertEqual(response.data['user']['first_name'], 'Asilbek')
        self.assertEqual(response.data['user']['username'], 'asilbek')
